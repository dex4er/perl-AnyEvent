...
Of course, if you want lots of policy (this is arguably somewhat useful
in many cases) and you want to force your users to the one and only event
model your module forces on them, you should I<not> use this module.
